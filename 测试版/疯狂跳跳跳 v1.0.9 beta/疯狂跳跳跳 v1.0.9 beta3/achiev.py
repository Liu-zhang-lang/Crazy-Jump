...
class Achiev:
    ...
    def check(self,achiev):
        ...
        if achiev=="new_record":
            ...
            return True
        elif achiev=="didn't_hurt_in_60s" and self.game.time>=60 and self.game.game_stats["hurt"]["cnt"]==0:
            return True
        elif achiev=="hurt_50_times" and self.game.game_stats["hurt"]["cnt"]>=50:
            return True
        return False
