...
class Health(pg.sprite.Sprite):
    def __init__(self,f):
        ...
        if (rd.random()<=0.05 and f!=1) or f==2:
            self.b=40
            self.number_text=cn_def.render("25",True,"red")
        else:
            self.b=rd.randint(15,35)
            self.number_text=cn_def.render(str(self.b//3),True,"white")
        ...
        self.rect=pg.Rect((rd.randint(0,w-self.b),rd.randint(200,450)),(self.b,self.b))
