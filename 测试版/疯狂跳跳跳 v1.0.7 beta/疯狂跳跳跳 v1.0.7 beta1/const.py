...
gamestop_texts={
    "游戏暂停":[(w/2,h/2-65),cn_big,"white",1,"center"],
    "按Esc或Enter继续游戏":[(0,55),cn_def,"white",2,"center"],
    "按R重新开始":[(0,35),cn_def,"white",2,"center"],
    "按G查看规则":[(0,35),cn_def,"white",2,"center"],
    "按P查看排行榜":[(0,35),cn_def,"white",2,"center"]
}