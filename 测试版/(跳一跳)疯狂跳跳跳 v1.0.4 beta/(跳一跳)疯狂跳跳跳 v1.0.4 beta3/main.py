...
pg.display.set_caption("跳一跳 v1.0.4 beta3")
#################################主程序#################################
Draw(g,he,player,inf,seconds,floor,heart)
texts={
    ...
    "3：躲避红色/紫色(加强)敌人，拾取绿色/黄色(加强)血包":[(50,155),chinese_font,"white"],
    "4：输入法为中文时，可能会导致部分按键失效":[(50,190),chinese_font,"white"],
    "5：按两次跳跃可以二段跳":[(50,225),chinese_font,"white"],
    "6：地图中会随机生成地板，可供站立3秒":[(50,260),chinese_font,"white"],
    "阅读完毕后，按下回车键开始游戏":[(50,295),chinese_font,"white"]
}
DrawText(texts)
pg.display.update()
while True:#等待开始
