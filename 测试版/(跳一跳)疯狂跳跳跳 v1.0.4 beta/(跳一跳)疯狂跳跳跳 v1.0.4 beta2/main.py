...
g.add(Enemy(1))
player.add(Player())
pg.display.set_caption("跳一跳 v1.0.4 beta2")
#################################主程序#################################
...
texts={
    ...
    "3：躲避红色/紫色(加强)敌人，拾取绿色/黄色(加强)血包，看看":[(50,155),chinese_font,"white"],
    "你能坚持多久":[(50,190),chinese_font,"white"],
    "4：输入法为中文时，可能会导致部分按键失效":[(50,225),chinese_font,"white"],
    "5：按两次跳跃可以二段跳":[(50,260),chinese_font,"white"],
