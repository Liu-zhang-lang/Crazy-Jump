...
class Debug:
    def __init__(self,game):
        ...
        self.spaces={}
        self.marks={}
        self.help_texts=pg.sprite.Group()
        self.game=game
        self.is_quit=False
    ...
    def get_help_texts(self,node,space,name):
        ...
        self.spaces[name]=cn_fonts[18].size(space)[0]
        if node["tag"]=="down":
            text=space+"- "+name+"["+node["tip"]+"]"
            self.help_texts=Info.add_info(self.help_texts,text,[270,self.cnt*30+50],font=cn_fonts[18],back_color=None)
