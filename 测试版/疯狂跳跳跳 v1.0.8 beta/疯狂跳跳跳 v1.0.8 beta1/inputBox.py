...
class InputBox(pg.sprite.Sprite):
    def __init__(self,x,y,width,height,outline_color,fill_color,tip,align="topleft",text="",is_selected=False,outline_width=2,font=cn_def,font_size=cn_def_sz,multiple_inputs=False,hidden_string=False):
        super().__init__()
