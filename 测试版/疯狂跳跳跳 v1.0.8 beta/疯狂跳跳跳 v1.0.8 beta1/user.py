...
class User:
    ...
    def init_button(self):
        ...
        if self.user_name=="":
            ...
            self.button.add(Button((230,30),80,30,"blue",text="登出"))
            self.button.add(Button((320,30),80,30,"blue",text="注销"))
            self.button.add(Button((410,30),80,30,"blue",text="修改名字",font=cn_sm))
        ...
        for bt in self.button:
            if bt.check_click():
                ...
                if bt.text=="注册" and bt.rect.y==30:
                    self.register()
                    return True
                if bt.text=="注销" and bt.rect.y==30:
                    self.unregister()
                    return True
    ...
    def unregister(self,input_psw=""):
        ...
        while running:
            ...
            for bt in self.button:
                if bt.check_click():
                    if bt.text=="注销" and bt.rect.y==130:
                        if input_psw=="":
                            self.info=Info.append_info(self.info,"密码不能为空！",self.info_pos,color="red",back_color=None)
                            bt.is_click=False
                            break
